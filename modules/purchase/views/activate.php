			   ...
			   <?php echo form_open($submit_url, ['autocomplete'=>'off', 'id'=>'verify-form']); ?>
                        <?php echo form_hidden('original_url', $original_url); ?>
                  		<?php echo form_hidden('module_name', $module_name); ?>
								<?php echo render_input('purchase_key', 'purchase_key', 'Nulled by codingshop.net', 'text', ['required'=>true]); ?>
                        <?php echo render_input('username', 'Envato Username', 'Nulled by codingshop.net', 'text', ['required'=>true]); ?>
