...
<?php if(isset($client)){ ?>
   ...
   $(function(){
      ...
      initDataTable('.table-table_pur_invoices', admin_url+'purchase/table_vendor_pur_invoices/'+<?php echo html_entity_decode($client->userid); ?>);

      initDataTable('.table-debit-notes', admin_url+'purchase/table_vendor_debit_notes/'+<?php echo html_entity_decode($client->userid); ?>);

      initDataTable('.table-pur_estimates', admin_url+'purchase/table_vendor_quoations/'+<?php echo html_entity_decode($client->userid); ?>);
   });
