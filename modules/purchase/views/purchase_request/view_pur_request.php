         ...
         <div class="col-md-12">
            ...
            ?></td>
                       ...
                       <tr class="project-overview">
                          ...
                          <td><?php 
                              if($pur_request->department == 1){
                                echo _l('IT');
                              }elseif($pur_request->department == 2){
                                echo _l('HR');
                              }elseif($pur_request->department == 3){
                                echo _l('Project');
                              }elseif($pur_request->department == 4){
                                echo _l('Marketing');
                       ...
                       <tr class="project-overview">
                          <td class="bold"><?php echo _l('Due Date'); ?></td>
                          <td><?php echo date($pur_request->due_date); ?></td>
                       </tr>
                      ...
                      <!-- <tr class="project-overview">
                       ...
                       <tr class="project-overview">
                          ...
                          <td><?php echo html_entity_decode($pur_request->bank_details); ?></td>
                       </tr>
                       <?php } ?>
                            ...
                            foreach ($list_approve_status as $value) {
                             ...
                             <div class="col-md-3 apr_div">
                                 ...
                                 <?php if($value['approve'] == 2){ 
                                  ?>
                                  <img src="<?php echo site_url(PURCHASE_PATH.'pur_request/signature/'.$pur_request->id.'/signature_'.$value['id'].'.png'); ?>">
                                   <br><br>
