                  ...
                  <div class="row ">
                    ...
                    ?>
                     <div class="row ">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-3 pright0">
                        <?php $due_date = (isset($pur_request) ? _d($pur_request->due_date) : '');
                         echo render_date_input('due_date','Due Date',$due_date); ?>
                        </div>
                    ...
                    <!-- <div class="col-md-3 form-group">
                      <label for="requester"><?php echo _l('requester'); ?></label>
                        <select style="pointer-events: none;" name="requester" id="requester" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                          <option value=""></option>
                          <?php foreach($staffs as $s) { ?>
                            <option value="<?php echo html_entity_decode($s['staffid']); ?>"
                              <?php if(isset($pur_request) && $s['staffid'] == $pur_request->requester){ echo 'selected'; }elseif($s['staffid'] == get_staff_user_id()){ echo 'selected'; } ?>>
                    ...
                    <div class="col-md-3 form-group" hidden>                        
                      <?php $pur_requester = ( isset($pur_request) ? $pur_request->requester : get_staff_user_id());
                      echo render_input('requester','requester',get_staff_user_id() ,'text',array('readonly' => '')); ?>
                    </div>
                    ...
                    <div class="col-md-3 form-group">
                            <label for="type"><?php echo _l('Purchase Type'); ?></label>
                              <select name="purchase_type" id="purchase_type" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                                ...
                                <option value="Pembiayaan" <?php if(isset($pur_request) && $pur_request->purchase_type == 'Pembiayaan'){ echo 'selected';} ?>><?php echo _l('Pembiayaan'); ?></option>
                              </select>
                              <br><br>
                          </div>
                        ...
                        <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                          <thead>
                            <tr>
                              ...
                              <th width="15%" align="right" class="item_description"><?php echo _l('item_description'); ?></th>
