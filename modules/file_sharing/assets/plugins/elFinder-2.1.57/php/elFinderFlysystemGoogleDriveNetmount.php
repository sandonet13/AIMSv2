...
if (!class_exists('fs_elFinderVolumeFlysystemGoogleDriveCache', false)) {
    class fs_elFinderVolumeFlysystemGoogleDriveCache extends ACache
    {
        use Hasdir;
...
class fs_elFinderVolumeFlysystemGoogleDriveNetmount extends ExtDriver
{
