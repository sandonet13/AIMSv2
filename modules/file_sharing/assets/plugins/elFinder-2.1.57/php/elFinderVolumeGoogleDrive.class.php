 ...
 **/
class fs_elFinderVolumeGoogleDrive extends fs_elFinderVolumeDriver
{
    /**
     * Driver id
    ...
    private function _gd_getFile($path, $fields = '')
    {
        ...
        try {
            ...
            if ($file instanceof Google\Service\Drive\DriveFile) {
                return $file;
            } else {
                return [];
            }
    ...
    protected function _mkdir($path, $name)
    {
        ...
        try {
            ...
            if ($obj instanceof Google\Service\Drive\DriveFile) {
    ...
    protected function _move($source, $targetDir, $name)
    {
        ...
        try {
            ...
            $files = new \Google\Service\Drive\DriveFile();
            $files->setName($name);
