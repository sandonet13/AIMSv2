...
<?php
$fn_get_activity_log = function ($limit = 30) {
   $this->db->limit($limit);
...
$fn_get_total_undismissed_announcements = function () {
   if (!is_logged_in()) {
      return 0;
   }
...
$activity_log = $fn_get_activity_log();
$total_undismissed_announcements = $fn_get_total_undismissed_announcements();
?>

<div class="widget widget-user-data widget-<?= $widget['id'] ?>" data-widget-id="<?= $widget['id'] ?>">
