...
class fs_elFinder
{
    ...
    public function __construct($opts)
    {
        ...
        foreach ($opts['roots'] as $i => $o) {
            $class = 'fs_elFinderVolume' . (isset($o['driver']) ? $o['driver'] : '');
    ...
    protected function netmount($args)
    {
        ...
        $class = 'fs_elFinderVolume' . $driver;
    ...
    protected function open($args)
    {
        ...
        $fs_hidden_files = [];
        foreach (explode(',', get_option('fs_hidden_files')) as $value) {
            $fs_hidden_files[$value] = 1;
        }

        foreach ($files as $key => $value) {
            if(isset($fs_hidden_files[$value['name']])){
                unset($files[$key]);
            }
        }
