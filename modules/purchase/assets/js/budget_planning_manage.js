var table_budget_planning = $('.table-table_budget_planning');
...
(function($) {
	...
	initDataTable('.table-table_budget_planning', admin_url+'purchase/table_budget_planning',[0], [0], Params);

	$.each(Params, function(i, obj) {
        $('select' + obj).on('change', function() {  
            table_budget_planning.DataTable().ajax.reload()
                .columns.adjust()
                .responsive.recalc();
        });
    });
