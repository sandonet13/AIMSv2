				...
				<table class="table dt-table" >
		            ...
		            <tbody>
		            	...
		            	foreach($quotations as $p){ ?>
		            		...
		            		?>
		            		<tr>
		            			<td><a href="<?php echo site_url('purchase/vendors_portal/view_quotation/'.$p['id']); ?>"><?php echo html_entity_decode(format_pur_estimate_number($p['id'])); ?></a></td>
		            			...
		            			<td>
		            				...
		            				<?php if($pr && !is_array($pr)){ ?>
		            					<a href="<?php echo site_url('purchase/vendors_portal/pur_request/'.$pr->id.'/'.$pr->hash); ?>"><?php echo html_entity_decode($pr->pur_rq_code); ?>
		            				<?php } ?>
		            			</td>
