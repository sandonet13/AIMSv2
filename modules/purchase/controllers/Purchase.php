        ...
        if($id != ''){
            ...
            if (count($data['pur_request_detail']) > 0) { 
                ...
                foreach ($data['pur_request_detail'] as $request_detail) {
                    ...
                    $purchase_request_row_template .= $this->purchase_model->create_purchase_request_row_template('items[' . $index_request . ']', $request_detail['item_code'], $item_text, $request_detail['item_description'], $request_detail['unit_price'], $request_detail['quantity'], $unit_name, $request_detail['into_money'], $request_detail['prd_id'], $request_detail['tax_value'], $request_detail['total'], $request_detail['remarks'], $request_detail['tax_name'], $request_detail['tax_rate'], $request_detail['tax'], true, $currency_rate, $to_currency);
                }
            }
        }
    ...
    public function coppy_pur_request_for_po($pur_request, $vendor = ''){
        ...
        if(count($pur_request_detail) > 0){
            ...
            foreach($pur_request_detail as $key => $item){
                ...
                $list_item .= $this->purchase_model->create_purchase_order_row_template('newitems[' . $index_quote . ']',  $item_name, $item['item_description'], $item['quantity'], $unit_name, $item['unit_price'], $taxname, $item['item_code'], $item['unit_id'], $item['tax_rate'],  $item['total'], '', '', $item['total'], $item['into_money'], $item['tax'], $item['tax_value'], $index_quote, true, $currency_rate, $to_currency);
            }
        }
        ...
        if ($id == '') {
            ...
            if (count($data['pur_order_detail']) > 0) { 
                ...
                foreach ($data['pur_order_detail'] as $order_detail) { 
                    ...
                    $pur_order_row_template .= $this->purchase_model->create_purchase_order_row_template('items[' . $index_order . ']',  $item_name, $order_detail['item_description'], $order_detail['quantity'], $unit_name, $order_detail['unit_price'], $taxname, $order_detail['item_code'], $order_detail['unit_id'], $order_detail['tax_rate'],  $order_detail['total_money'], $order_detail['partno'], $order_detail['discount_%'], $order_detail['discount_money'], $order_detail['total'], $order_detail['into_money'], $order_detail['tax'], $order_detail['tax_value'], $order_detail['id'], true, $currency_rate, $to_currency);
                }
            }
        }
...
/**
    ...
    public function get_purchase_request_row_template(){
        ...
        echo $this->purchase_model->create_purchase_request_row_template( $name, $item_code, $item_description, $item_text, $unit_price, $quantity, $unit_name, $into_money, $item_key, $tax_value, $total, $remarks, $tax_name, '', '', false, $currency_rate, $to_currency);
    }
    ...
    public function get_purchase_order_row_template(){
        ...
        echo $this->purchase_model->create_purchase_order_row_template($name, $item_name, $item_description, $quantity, $unit_name, $unit_price, $taxname, $item_code, $partno, $unit_id, $tax_rate, '', $discount, '', '', '', '', '', $item_key, false, $currency_rate, $to_currency);
    }
